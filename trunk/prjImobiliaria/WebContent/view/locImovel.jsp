...
<body>
	...
	<% 
		...
		if(session.getAttribute("Imovel") != null){
			qi.edu.br.model.TipoImovel tp = new qi.edu.br.model.TipoImovel();
			tp = (qi.edu.br.model.TipoImovel)session.getAttribute("Imovel");
			out.println("<br />");
			out.println("<br />");
			out.println("<br />");
			...
			out.println("<tr>");
				out.println("<td><a href=\'locImovel.jsp?alterar=alterar&id="+tp.getId()+"\'>Alterar</a>");out.println("</td>");
				out.println("<td><a href=\'locImovel.jsp?excluir=excluir&id="+tp.getId()+"\'>Excluir</a>");out.println("</td>");
			out.println("</tr>");
